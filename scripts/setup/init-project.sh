...
for command in triage-intake dispatch-task dispatch-now apply-dispatch watch-dispatch dispatch-queue apply-ticket request-triage approve-ticket reject-ticket; do
	render_command_template \
